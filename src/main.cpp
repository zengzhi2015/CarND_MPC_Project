    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Do transformation first (global_cords -> car coords)
          // polyfit() accepts eigen vectors only
...
//          py = 0;
//          psi = 0;
          // Deal with latency by predicting the actual position of the car
          // Note: This can be calculated by predicting the new position of the car
          // "latency" times later.
//          double latency = 0.1;
...
//          v = v + acceleration*latency;
          ...
          */
          ...
          // Solve the optimization problem and return the first action
...
//          for (int i = 0; i < 4; i++ ) {
//            double dx = vars[2+i*2] - px;
//            double dy = vars[2+i*2+1] - py;
